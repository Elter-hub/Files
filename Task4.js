...
// sortZero([2, 1, 0 , 34, 25, 56, 0, 3423, 0, 232, 0, 32, 0, 232, 3, 0, 34, 0, 34, 5, 0, 4, 5, 0, 4,])
//
...
//     {title: 'Седьмое правило Бойцовского клуба.',body: 'Если противник потерял сознание или делает вид, что потерял, ' +
//             '                                                       или говорит «Хватит» — поединок окончен.'},
//     {title: 'Восьмое и последнее правило Бойцовского клуба.',body: 'Новичок обязан принять бой.'},
// ];
//
// function fightingClub(arrayOfObjects){
//     let container = document.createElement('div');
//     container.id = "wrap";
//     for (let i = 0; i < arrayOfObjects.length; i++) {
//         let block = document.createElement('div');
//         block.id = `Rule number ${i + 1}`;
//         let rule = document.createElement("h2");
//         rule.innerText = arrayOfObjects[i].title;
//         let text = document.createElement("p");
//         text.innerText = arrayOfObjects[i].body;
//
//         document.body.appendChild(container);
//         container.appendChild(block);
