...
//
//
// let imgArray = ["images/image1.jpg", "images/image2.jpg", "images/image3.jpg", "images/image4.jpg"]
...
//     paragraph.innerHTML = paragraph.innerHTML.replace(`${text.substring(start, end)}`, `${text.substring(start, end)}`)
